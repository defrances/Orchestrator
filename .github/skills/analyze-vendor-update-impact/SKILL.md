...
Write **one** issue for that group. Put every member advisory, package, CVE, policy, and score in the Updates table. The "How this can affect" section is written **once** for the coupling. Do not copy the same paragraph and only swap the CVE title.
